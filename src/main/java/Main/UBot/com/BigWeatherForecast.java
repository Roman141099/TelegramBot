...
public class BigWeatherForecast {
    ...
    private transient final Map<String, String> emoji1 = Map.of("01d", "☀",
            "02d", "⛅",
            "03d", "☁",
            "04d", "☁",
            "09d", "\uD83C\uDF27",
    ...
    public String shortDescription() {
        return days.stream().map(o -> String.format("%s %d %s, %s\n\t· День : %2.2f \u2103\n\t· %s",
                        ...
                        o.getTemp().getDay(), o.getWeather().getDescription())).collect(Collectors.joining("\n"));
    }
    @Override
    public String toString() {
        return days.stream().map(o -> String.format("%s %d %s, %s\n\t· День : %2.2f \u2103\n\t· Ночь : %2.2f \u2103\n\t· Ощущается как : %2.2f \u2103\n\t· %s, %s",
                ...
                o.getDate(ZoneId.of(timezone)).getMonth().getDisplayName(TextStyle.FULL, Locale.forLanguageTag("ru")),
                o.getDate(ZoneId.of(timezone)).getDayOfWeek().getDisplayName(TextStyle.FULL, Locale.forLanguageTag("ru")),
                o.getTemp().getDay(), o.getTemp().getNight(), o.getFeels_like().getDay(), o.getWeather().getMain(),
